...
public class ViewInvoicedSOActivity extends AppCompatActivity {
    ...
    JSONArray jsonArray;
    ViewInvoicedListAdpter viewInvoicedListAdpter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_invoiced_so);
        ...
        new getViewInvoicedList().execute();
    ...
    public void addTextListener() {
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence query, int start, int before, int count) {
                ...
                viewInvoicedListAdpter = new ViewInvoicedListAdpter(ViewInvoicedSOActivity.this, filteredList);
                mProductList.setAdapter(viewInvoicedListAdpter);
                mProductList.setLayoutManager(new LinearLayoutManager(ViewInvoicedSOActivity.this));
                viewInvoicedListAdpter.notifyDataSetChanged();  // data set changed
            }
        });
    }

    private class getViewInvoicedList extends AsyncTask<Void, Void, Void> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            // Create a progressdialog
            mProgressDialog = new ProgressDialog(ViewInvoicedSOActivity.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            viewInvoicedListResponse = serviceAccess.SendHttpPost(Config.SHOWUNDERINVOICESTATUS, jsonLeadObj);
        ...
        protected void onPostExecute(Void args) {
            if (data.size() > 0) {
                viewInvoicedListAdpter = new ViewInvoicedListAdpter(ViewInvoicedSOActivity.this, data);
                mProductList.setAdapter(viewInvoicedListAdpter);
                mProductList.setLayoutManager(new LinearLayoutManager(ViewInvoicedSOActivity.this));
