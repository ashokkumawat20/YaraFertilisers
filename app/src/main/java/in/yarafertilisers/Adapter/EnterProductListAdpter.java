...
import in.yarafertilisers.Activity.EnterSalesOrderActivity;
...
public class EnterProductListAdpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public EnterProductListAdpter(Context context, List<EnterProductDAO> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.layout_enter_product_details, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        myHolder.deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialog.setTitle("deleting product");
                alertDialog.setMessage("Do you want delete product ");
