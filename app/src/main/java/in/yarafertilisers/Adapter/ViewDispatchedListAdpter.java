...
import in.yarafertilisers.View.ViewDispatchedDetailsView;
...
public class ViewDispatchedListAdpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ViewDispatchedListAdpter(Context context, List<ViewInvoicedDAO> data) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        myHolder.lead_Layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                prefEditor.commit();
                ViewDispatchedDetailsView viewDispatchedDetailsView = new ViewDispatchedDetailsView();
                viewDispatchedDetailsView.show(((FragmentActivity) context).getSupportFragmentManager(), "viewDispatchedDetailsView");
            }
        });
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        TextView sr, orderDate, order_no, dealerName, salesrepcomment, invrepcomment, dispatrepcomment;
