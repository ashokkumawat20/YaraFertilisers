...
public class InvoicedDetailsListAdpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    public Context context;
    public LayoutInflater inflater;
    List<InvoicedProductDAO> data;
    InvoicedProductDAO current;
    int currentPos = 0;
    String id;
    int ID;
    ...
    public InvoicedDetailsListAdpter(Context context, List<InvoicedProductDAO> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.layout_view_invoiced_details, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        myHolder.inVoiceDate.setText("Invoice Date : "+current.getInvoice_date());
        ...
        myHolder.userName.setText(current.getUser_name());
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        TextView sr, inVoiceDate, invoiceNo, wharehouse, userName;
    ...
    public List<InvoicedProductDAO> getSservicelist() {
        return data;
    }
